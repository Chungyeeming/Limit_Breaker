package org.limit_breaker.UTILITIES.WORLD;

import org.limit_breaker.UTILITIES.MainNumbers;
...
public final class WorldBounds {
     ...
     */
    public static final int MAX_PLAYABLE_BLOCK = MainNumbers.MAX_PLAYABLE_BLOCK;

    public static final int MIN_PLAYABLE_BLOCK = ~MainNumbers.MAX_PLAYABLE_BLOCK;

    /**
     * 正方向最后一个可玩 chunk = 134,217,726 = 2^27-2。
     */
    public static final int MAX_PLAYABLE_CHUNK = MainNumbers.MAX_PLAYABLE_CHUNK;

    public static final int MIN_PLAYABLE_CHUNK = ~MainNumbers.MAX_PLAYABLE_CHUNK;
