...
public class MainNumbers {
    ...
    public static final int MAX_PLAYABLE_CHUNK = MAX_CHUNK - 1; // 134217726
    public static final int MAX_PLAYABLE_BLOCK = (MAX_PLAYABLE_CHUNK << 4) + 15; // 2147483631;   //最大可遊玩的區塊
